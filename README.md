...
- Build date: 2021-08-26T14:44:43.637536-04:00[America/Toronto]
...
```kotlin
implementation("com.equisoft.plan.sdk:equisoft-plan-sdk-micronaut:0.0.0-SNAPSHOT")
```
...
## Documentation for Models
 ...
 - [V1CopyFnaResponse](docs/V1CopyFnaResponse.md)
 - [V1CopyFnaResponseData](docs/V1CopyFnaResponseData.md)
