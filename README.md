...
- Build date: 2022-03-17T17:25:02.697195Z[Etc/UTC]
...
```kotlin
implementation("com.equisoft.plan.sdk:equisoft-plan-sdk-micronaut:6.60.5-SNAPSHOT")
```
...
<dependency>
  ...
  <version>6.60.5-SNAPSHOT</version>
  <scope>compile</scope>
</dependency>
```
